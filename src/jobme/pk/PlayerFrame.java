...
public class PlayerFrame extends javax.swing.JFrame {
    ...
    // Definir la clase MP3Player de grupo de techicas de pruebas
    MP3Player player;
    // Definir archivo para la canción
    File songFile;
    // Definir el directorio actual como si utilizamos JFileChooser entonces donde statys.
    String currentDirectory = "home.user"; // Estoy usando home.user esto llamará al selector de archivos en los documentos del usuario.
    // Aquí defino currentPath de la clase de aplicación en ejecución
    String currentPath;
    // Esta cadena será para el nombre o la ruta de la imagen
    String imagePath;
    // Necesitamos establecer el título de la aplicación como una cadena
    String appName = "GRUPO DE METODO DE PRUEBAS - (MP3 Player)";
    
    // Ahora comprueba si el botón de repetición está activado o no
    boolean repeat = false;
    
    // Aquí estoy haciendo un booleano para windowCollapsed
    boolean windowCollapsed = false;
    
    // Aquí necesito definir el x y el y del ratón para obtener la posición del ratón en la pantalla.
    int xMouse, yMouse;
    
    public PlayerFrame() {
        initComponents();
        // Establezca el título de la aplicación aquí
        appTitle.setText(appName);
        
        // Aquí voy a establecer un archivo de canciones por defecto. No es necesario.
        songFile = new File("C:\\Users\\AGUILAR\\Music\\musica\\musicapro.mp3");
        
        // Ahora haz una cadena para obtener el nombre del archivo
        String fileName = songFile.getName();
        // Aquí se establece nuestra etiqueta de nombre de la canción con este nombre
        songNameDisplay.setText(fileName);
        
        // Añadir nuestro método a la variable del jugador
        player = mp3Player();
        // Ahora añade la canción al reproductor como lista de reproducción.
        player.addToPlayList(songFile);
        
        // Aquí se obtiene la ruta actual y la ruta de las imágenes en cadenas
    ...
    private void settingsBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_settingsBtnMouseClicked
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(this, "Su dilog de configuración aparecerá aquí!");
    ...
    private void openBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_openBtnMouseClicked
        ...
        openFileChooser.setFileFilter(new FileTypeFilter(".mp3", "Abrir sólo archivos MP3!"));
    ...
    // Voy a crear un método MP3Player personalizado
    private MP3Player mp3Player(){
        MP3Player mp3Player = new MP3Player();
        return mp3Player;
    }
    
    // Método de bajar el volumen No es necesario recordar este código.
    private void volumeDownControl(Double valueToPlusMinus){
        // Obtener información del mezclador desde el sistema de audio
        Mixer.Info[] mixers = AudioSystem.getMixerInfo();
        // Ahora usa un bucle for para listar todos los mezcladores
        for(Mixer.Info mixerInfo : mixers){
            // Obtenga el mezclador
            Mixer mixer = AudioSystem.getMixer(mixerInfo);
            // Ahora consiga la línea de destino
            Line.Info[] lineInfos = mixer.getTargetLineInfo();
            // Aquí también se utiliza el bucle for para listar las líneas
            for(Line.Info lineInfo : lineInfos){
                // Hacer una línea nula
                Line line = null;
                // Hacer un booleano como abierto
                boolean opened = true;
                // Ahora usa la excepción try para abrir una línea
                try{
                    line = mixer.getLine(lineInfo);
                    opened = line.isOpen() || line instanceof Clip;
                    // Compruebe ahora si la línea no está abierta
                    if(!opened){
                        // Línea abierta
                        line.open();
                    }
                    // Hacer un control del flotador
                    FloatControl volControl = (FloatControl) line.getControl(FloatControl.Type.VOLUME);
                    // Obtenga el volumen actual ahora
                    float currentVolume = volControl.getValue();
                    // Crea una variable doble temporal y almacena el valorPlusMinus
                    Double volumeToCut = valueToPlusMinus;
                    // Hacer un flotador y calcular la adición o sustracción en volumen
                    float changedCalc = (float) ((float)currentVolume-(double)volumeToCut);
                    // Ahora ponga este valor modificado en la línea de volumen.
                    volControl.setValue(changedCalc);
                    
                }catch (LineUnavailableException lineException){
                }catch (IllegalArgumentException illException){
                }finally{
                    // Cerrar Línea Si se abrió
                    if(line != null && !opened){
                        line.close();
                    }
                }
    ...
    // Método para subir el volumen No es necesario recordar este código.
    ...
    // Fijemos el método del volumen No es necesario recordar este código.
